<h2><a href="https://www.geeksforgeeks.org/problems/longest-alternating-subsequence5951/1?page=1&difficulty=Medium,Hard&status=unsolved&sprint=50746f92a895c22a50504ac0c1fb9c84&sortBy=submissions">Longest alternating subsequence</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A sequence {x1, x2, .. xn} is alternating sequence if its elements satisfy one of the following relations :<br>
